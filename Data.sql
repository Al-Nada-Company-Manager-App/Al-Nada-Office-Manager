...
CREATE TABLE PURCHASE (
    ...
    PCH_CUSTOMSNUM INT,
    S_ID INT,
    FOREIGN KEY (S_ID) REFERENCES SUPPLIER(S_ID) ON DELETE
    SET NULL ON UPDATE CASCADE
);
CREATE TABLE DEBTS (
    ...
    SL_ID INT,
    FOREIGN KEY (SL_ID) REFERENCES SALES(SL_ID) ON DELETE
    SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE REPORT(
    ...
    RP_TYPE VARCHAR(50)
    /*thats for the type of the report*/
);
CREATE TABLE PREPARE_REPORT (
    ...
    C_ID INT,
    P_ID INT,
    FOREIGN KEY (E_ID) REFERENCES EMPLOYEE(E_ID) ON DELETE
    SET NULL ON UPDATE CASCADE,
        FOREIGN KEY (C_ID) REFERENCES CUSTOMER(C_ID) ON DELETE
    SET NULL ON UPDATE CASCADE,
        FOREIGN KEY (P_ID) REFERENCES STOCK(P_ID) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO PURCHASE_ITEMS (P_ID, PCH_ID, PI_QUANTITY, P_CATEGORY, PI_TOTAL)
VALUES (1, 1, 10, 'Category A', 500),
    (2, 1, 5, 'Category B', 500);
INSERT INTO PURCHASE_ITEMS (P_ID, PCH_ID, PI_QUANTITY, P_CATEGORY, PI_TOTAL)
VALUES (1, 2, 15, 'Category A', 750),
