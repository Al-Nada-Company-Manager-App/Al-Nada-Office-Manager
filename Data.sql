...
CREATE TABLE NOTIFICATION (
    ...
    ON DELETE CASCADE
    ON UPDATE CASCADE,
    FOREIGN KEY (D_ID) REFERENCES DEBTS(D_ID)
    ON DELETE CASCADE
    ON UPDATE CASCADE
);
...
INSERT INTO EMPLOYEE (F_NAME, L_NAME, Birth_Date, SALARY, E_ROLE, E_PHOTO, E_ADDRESS, E_CITY, E_COUNTRY, E_ZIPCODE, E_USERNAME, E_PASSWORD, E_GENDER,E_ACTIVE)
VALUES ('Ahmed', 'Fathy', '2004-04-19', 10000, 'Manager', 'ahmed.jpg', 'Giza', 'Giza', 'Egypt', '12345', 'ahmed', '$2b$10$OwzytpGyHBO1XYredXi1Wu2lWJ36oRCPL33S6cimYiYEEkDQcik5e', 'male',true);

INSERT INTO CUSTOMER (C_NAME, C_ADDRESS, C_CITY, C_COUNTRY, C_ZIPCODE, C_FAX, C_PHONE)
VALUES 
('Customer A', '123 Main St', 'New York', 'USA', '10001', '123-456-7890', '123-456-7890'),
('Customer B', '456 Elm St', 'Los Angeles', 'USA', '90001', '987-654-3210', '987-654-3210'), 
('Customer C', '789 Oak St', 'Chicago', 'USA', '60001', '456-789-0123', '456-789-0123');
...
INSERT INTO SUPPLIER (S_NAME, S_ADDRESS, S_CITY, S_COUNTRY, S_ZIPCODE, S_FAX, S_PHONE, S_EMAIL, S_PHOTO)
VALUES 
('Supplier A', '123 Main St', 'New York', 'USA', '10001', '123-456-7890', '123-456-7890', 'supplierA@example.com', 'photoA.jpg'),
('Supplier B', '456 Elm St', 'Los Angeles', 'USA', '90001', '987-654-3210', '987-654-3210', 'supplierB@example.com', 'photoB.jpg');


INSERT INTO PURCHASE (PCH_DATE, PCH_TOTAL, PCH_TAX, PCH_COST, PCH_BILLNUM, PCH_CURRENCY, PCH_EXPENSE, PCH_CUSTOMSCOST, PCH_CUSTOMSNUM, S_ID)
VALUES 
('2024-01-01', 1000, 100, 900, 12345, 'USD', 50, 200, 54321, 1), 
('2024-01-15', 1500, 150, 1350, 12346, 'USD', 60, 300, 54322, 2); 
