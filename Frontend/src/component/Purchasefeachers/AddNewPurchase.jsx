        ...
        >
          <Row gutter={16}>
                ...
                rules={[
                  {
                    ...
                    validator: (_, value) =>
                      selectedSupplier
                        ? Promise.resolve()
                        : Promise.reject("Please select a supplier."),
                  },
                ]}
              >
            ...
            <Col span={12}>
              <Form.Item
                ...
                rules={[
                  ...
                  {
                    type: "string",
                    message: "Bill number must be a valid string.",
                  },
                ]}
              >
              ...
              <Form.Item
                ...
                rules={[
                  { required: true, message: "Expense is required." },
                  {
                    type: "number",
                    min: 0,
                    message: "Expense must be non-negative.",
                  },
                ]}
              >
                <InputNumber
            ...
            <Col span={12}>
              ...
              >
                <InputNumber value={Total} readOnly style={{ width: "100%" }} />
              </Form.Item>
            </Col>
