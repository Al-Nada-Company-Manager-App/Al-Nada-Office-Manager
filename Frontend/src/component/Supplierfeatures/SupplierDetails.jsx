...
import { fetchPurchaseHistory,handleDeleteSupplier,fetchSuppliers,setSupplierModalVisible,setSelectedSupplier } from "../../Store/Supplier";
...
const SupplierDetails = () => {
     ...
     const {selectedSupplier,supplierModalVisible,supplierPurchasesData,PurchaseLoading} = useSelector((state) => state.Suppliers);
    
      useEffect(() => {
        if (selectedSupplier)
          dispatch(fetchPurchaseHistory(selectedSupplier.s_id));
      }, [selectedSupplier]);
    ...
    return (
      ...
      <Modal
          ...
          footer={[
              ...
              <Button key="Delete Supplier" onClick={() => handleDelete(selectedSupplier.s_id)  } type="primary" danger >
                  Delete Purchase
              </Button>,
